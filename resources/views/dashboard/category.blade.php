    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-xs-center">Add Category</h4>
            </div>
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div>
                            <button id="create-category" class="btn btn-success btn-block">Add</button>
                        </div>
                    </div>
...
<div id="ModalEdit" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-xs-center">Edit Category</h4>
            </div>
            ...
            <div class="modal-body">
                    <div class="form-group">
                        <label class="control-label">Category Name</label>
                        <div>
                            <input type="text" id="category-id" class="form-control input-lg" name="id" value="" hidden>
                            <input type="text" id="category-name" class="form-control input-lg" name="edit_name" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Slug Name</label>
                        <div>
                            <input type="text" id="category-slug" class="form-control input-lg" name="edit_slug" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div>
                            <button id="update-category" class="btn btn-success btn-block">Update</button>
                        </div>
                    </div>
            </div>
        </div><!-- /.modal-content -->
            ...
            <div class="modal-body">
              <h4>Anda yakin ?</h4>
                <form role="form" method="POST" action="{{route('delete_category')}}">
                  @csrf
                    <div class="form-group">
                        <input type="text" id="category-id-delete" class="form-control input-lg" name="id" value="" hidden>
                    </div>
    ...
    $('.edit').on('click', function(){
      ...
      $('#update-category').on('click', function(){
        ...
        $.ajax({
                url: "update_category",
                type:'POST',
                data: {'_token': '{{csrf_token()}}', name:name,slug:slug, id:id},
                success: function(data) {
                    if($.isEmptyObject(data.error)){
                      ...
                      setTimeout(function(){ window.location.assign("{{ route('category') }}"); }, 1500);
                    }else{
